...
ALLOWED_EXTENSIONS=("sh" "java" "bash" "cpp" "js" "jsx" "css" "csx" "ts" "go" "rb" "yml" "yaml" "tf" "py")
...
extract_files() {
  ...
  done < <(find "$root_dir" -mindepth 1 -maxdepth "$max_depth" -type f \( -path "*/node_modules/*" -o -path "*/.git/*" -o -path "*/__pycache__/*" -o -path "*/dist/*" -o -path "*/build/*" -o -path "*/venv/*" \) -prune -o -print0)
...
analyze_requirements() {
  ...
  for req in "${requirements[@]}"; do
    ...
    done < <(find "$root_dir" -mindepth 1 -maxdepth 4 -type f \( -path "*/node_modules/*" -o -path "*/.git/*" -o -path "*/__pycache__/*" -o -path "*/dist/*" -o -path "*/build/*" -o -path "*/venv/*" \) -prune -o -print0)
